        ...
        <div className="flex-1 rounded-md border border-neutral-200 bg-white p-6 shadow order-2 md:order-1">
              ...
              <h2 className="text-2xl font-bold text-black" style={{ fontFamily: 'var(--font-dm-sans)' }}>Platform Overview</h2>
                ...
                <div className="bg-[#d19900]/10 border border-[#d19900] rounded-md p-4 mb-6">
                  ...
                  <p className="text-black" style={{ fontFamily: 'var(--font-dm-sans)' }}>
                    In times of market volatility and downturns, TrenchSeek provides a stable platform for connecting talent with opportunities, ensuring that builders and contributors can continue to earn and grow even when token prices are struggling.
                  </p>
                </div>
          ...
          {activeSection === 'for-job-seekers' && (
            <div className="space-y-4">
              ...
              <div className="prose max-w-none text-black">
                <p className="text-black mb-4" style={{ fontFamily: 'var(--font-dm-sans)' }}>
                  TrenchSeek provides multiple ways for crypto professionals to find income opportunities, especially during challenging market conditions.
                </p>
          ...
          {activeSection === 'for-job-posters' && (
            <div className="space-y-4">
              ...
              <div className="prose max-w-none text-black">
                <p className="text-black mb-4" style={{ fontFamily: 'var(--font-dm-sans)' }}>
                  TrenchSeek offers a unique platform for companies, projects, and individuals to find qualified talent in the crypto space, with innovative features that go beyond traditional job boards.
                </p>
                
                <h3 className="text-xl font-bold mb-2" style={{ fontFamily: 'var(--font-dm-sans)' }}>Creating Job Listings</h3>
                <p className="text-black mb-4" style={{ fontFamily: 'var(--font-dm-sans)' }}>
                  Posting a job on TrenchSeek is simple:
                </p>
          ...
          {activeSection === 'tokenization' && (
            <div className="space-y-4">
              ...
              <div className="prose max-w-none text-black">
                <p className="text-black mb-4" style={{ fontFamily: 'var(--font-dm-sans)' }}>
                  One of TrenchSeek's most innovative features is the ability to tokenize job listings, creating a new economic layer on top of the traditional job marketplace.
                </p>
          ...
          {activeSection === 'rewards' && (
            <div className="space-y-4">
              ...
              <div className="prose max-w-none text-black">
                <p className="text-black mb-4" style={{ fontFamily: 'var(--font-dm-sans)' }}>
                  TrenchSeek features a rewards system designed to incentivize participation and quality contributions to the platform ecosystem, creating additional earning opportunities during challenging market conditions.
                </p>
                ...
                <p className="text-black" style={{ fontFamily: 'var(--font-dm-sans)' }}>
                  Our rewards system is specifically designed to create economic opportunities during crypto market downturns, providing alternative income streams and value creation mechanisms when traditional crypto investments may be struggling. By participating in the TrenchSeek ecosystem, both job seekers and job posters can maintain activity and potential income even in challenging market conditions.
                </p>
              </div>
            </div>
          )}
